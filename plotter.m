...
function plotter()
    ...
    %and builds the UI
    p.sampleRate = 250;
    p.handles = buildUI(p.sampleRate);
    addPaths;
...
%create the objects
    ...
    processObjects.FFTPlot = BCI_FFTPlot(p.sampleRate,"AxisHandle",p.handles.fft_plot, "BufferSeconds",fftDuration);
